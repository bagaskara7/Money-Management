...
public class AddOutcomeActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpinnerCategoriesAdapter adapter = new SpinnerCategoriesAdapter(this, R.layout.spinner_layout, R.id.spinnerText, dbAdapter.getCatsData("o"));
        ...
        if (extras != null) {
            if (extras.getInt("exp_id") != 0) {
                spinner.setSelection(extras.getInt("exp_id") - 5);
            } else if (extras.getInt("account_id") != 0) {
...
//        getMenuInflater().inflate(R.menu.menu_add_outcome, menu);
        return true;
    }
...
//            NavUtils.navigateUpFromSameTask(this);
            ...
            case R.id.date_picker_field:
                builder = new DatePickerDialog.Builder(){
                    ...
                    public void onPositiveActionClicked(DialogFragment fragment) {
                        ...
                        String date = dialog.getFormattedDate(SimpleDateFormat.getDateTimeInstance(SimpleDateFormat.FULL, SimpleDateFormat.DEFAULT, new Locale(dbAdapter.getActiveLang())));//DateFormat.getDateTimeInstance());
    ...
    public void addOutcome(View view) throws ParseException {
        String type = "o";
